...
@section('subtitle', 'Gestion des accès et des rôles')
                    ...
                    <table class="table table-modern mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('utilisateurs.edit', $u) }}" class="btn btn-sm btn-outline-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    @if($u->id !== auth()->id())
                                    <form method="POST" action="{{ route('utilisateurs.destroy', $u) }}" class="d-inline">
                                        @csrf @method('DELETE')
                                        <button class="btn btn-sm btn-outline-danger" onclick="return confirm('Désactiver cet utilisateur ?')">
