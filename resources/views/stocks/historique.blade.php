...
@section('title', 'Historique — ' . $produit->nom)
@section('subtitle', 'Mouvements de stock de ce produit')
    ...
    <div class="col-12">
        <div class="card animate-fadeInUp">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold"><i class="fas fa-history me-2 text-info"></i>{{ $produit->nom }}
            ...
            <div class="card-body p-0">
                ...
                <div class="text-center py-5 text-muted">
                    <i class="fas fa-inbox fa-2x mb-2 d-block"></i>Aucun mouvement de stock enregistré pour ce produit
                </div>
                @endif
            </div>
        </div>
