    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse" id="sidebarMenu">
                <div class="position-sticky pt-4">
                    <div class="text-center mb-4 px-3">
                        ...
                        <small class="text-muted">Gestion Professionnelle</small>
                    </div>
                    ...
                    <div class="text-center px-3">
                        <div class="bg-light rounded-3 p-3 mb-3">
                            ...
                            <div class="small text-muted">Mode Hors Ligne</div>
                            <div class="small fw-bold">Version 1.0.0</div>
                        </div>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="main-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h2 class="mb-0 fw-bold">@yield('title', 'Tableau de bord')</h2>
                                <p class="text-muted mb-0">@yield('subtitle', 'Gestion de boutique professionnelle')</p>
                            </div>
                        </div>
                        <div>
                ...
                <!-- Flash Messages -->
                @if(session('success'))
                    <div class="alert alert-success alert-dismissible fade show mt-4 animate-fadeInUp" role="alert">
                ...
                @if(session('error'))
                    <div class="alert alert-danger alert-dismissible fade show mt-4 animate-fadeInUp" role="alert">
